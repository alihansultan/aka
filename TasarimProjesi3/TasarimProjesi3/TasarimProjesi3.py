...
def UPGMAPenceresi():
    ...
    hesaplama = tk.Button(window, text="Hesaplamaları Gör", padx=10, pady=5, fg="white", bg="#263D42", command=Hesaplamalar)
    hesaplama.pack()

    calistir = tk.Button(window, text="UPGMA sonucunu görmek için tıkla", padx=10, pady=5, fg="white", bg="#263D42", command=UPGMAHesabi)
    calistir.pack()

    dosyaAcmaEtiketi = tk.Button(window, text="Metin dosyasini ac", padx=10, pady=5, fg="white", bg="red", command=dosyaAc).place(x=190, y=290)
...
def MaxParsimonyPenceresi():
    ...
    frame.place(relwidth=0.8, relheight=0.8, relx=0.1, rely=0.1)
    label__0 = Label(window2, text = "Maksimum Parsimony Hesaplama", fg = 'magenta',  font = ('arial', 18, 'bold')).place(x=170, y=90)
    label1 = Label(window2, text = "Sekansları metin dosyasında görmek için tıklayınız.", fg = 'red',  font = ('arial', 13, 'bold')).place(x=170, y=160)

    dosyaAcmaEtiketi = tk.Button(window2, text="Metin dosyasini ac", padx=10, pady=5, fg="white", bg="red", command=dosyaAc2).place(x=290, y=190)
    ...
    uyari = Label(window2, text = "Dikkat! Hesaplama süreci 5 ila 10 sn sürmektedir.", fg = 'black',  font = ('arial', 9, 'bold')).place(x=220, y=355)
...
def NeighborJoiningPenceresi():
    ...
    dosyaAcmaEtiketi = tk.Button(window3, text="Metin dosyasini ac", padx=10, pady=5, fg="white", bg="red", command=dosyaAc3).place(x=190, y=300)
    ...
    calistir = tk.Button(window3, text="Neighbor Joining sonucunu görmek için tıklayınız", padx=10, pady=5, fg="white", bg="#734a12", command=main2)
    calistir.pack()
...
def FitchPenceresi():
    ...
    frame.place(relwidth=0.8, relheight=0.8, relx=0.1, rely=0.1)
    dosyaAcmaEtiketi = tk.Button(window4, text="Metin dosyasini ac", padx=10, pady=5, fg="white", bg="red", command=dosyaAc4).place(x=240, y=300)
    ...
    calistir = tk.Button(window4, text="Fitch Hesapla", padx=10, pady=5, fg="white", bg="#734a12", command=main3).place(x=255, y=390)
    uyari = Label(window4, text = "Dikkat! Hesaplama süreci 5 ila 10 sn sürmektedir.", fg = 'black',  font = ('arial', 9, 'bold')).place(x=150, y=430)

    cik4 = tk.Button(window4, text="Çık", padx=10, pady=5, fg="white", bg="#434343", command=geriDon)
    cik4.pack()
...
def main3():
    ...
    cik4 = tk.Button(window, text="Çık", padx=10, pady=5, fg="white", bg="#434343", command=geriDon)
    cik4.pack()
    window.mainloop()
...
upgmaHesabi = tk.Button(root, text="UPGMA", padx=10, pady=5, fg="white", bg="#263D42", font=('arial', 13, 'bold'), command=UPGMAPenceresi).place(x=200, y=180)


maxParsimonyHesabi = tk.Button(root, text="Maksimum Parsimony", padx=10, pady=5, fg="white", bg="#00a778", font=('arial', 13, 'bold'), command=MaxParsimonyPenceresi).place(x=145, y=240)


neighborjoiningHesabi = tk.Button(root, text="Neighbor Joining", padx=10, pady=5, fg="white", bg="pink", font=('arial', 13, 'bold'), command=NeighborJoiningPenceresi).place(x=165, y=300)

fitchHesabi = tk.Button(root, text="Fitch Algoritması", padx=10, pady=5, fg="white", bg="#ba2b1a", font=('arial', 13, 'bold'), command=FitchPenceresi).place(x=165, y=360)




cikis = tk.Button(root, text="Çıkış yap", padx=10, pady=5, fg="white", bg="red", font=('arial', 9, 'bold'), command=cikis)
cikis.pack()
